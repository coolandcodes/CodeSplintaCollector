...
config :tlc_app, CoolCodesCollector.Web.Endpoint,
...
#
#     config :coolcodes_collector, coolcodes_collector.Web.Endpoint,
#       ...
...
# start per endpoint:
#
#     config :coolcodes_collector, CoolCodesCollector.Web.Endpoint, server: true
#
